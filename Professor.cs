...
namespace OOPS_Class_Library
{
    ...
    {  static int Id = 1001;
        ...
        public Professor(string name, DOB dob, int genderchoice, int maritalchoice, string phoneNo, string email_id, string address, string position ,int shiftchoice,int salary)
        {
            ...
            this.shift = (Professor_shift)shiftchoice;
            this.salary = salary;
            this.date_of_joining = DateTime.Now.ToString("dd'-'MM'-'yyyy");
        }
        public enum Professor_shift
        {
            Day = 1,
            Evening= 2
        }
